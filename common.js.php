...
function t_registros_publicaciones_ppam_publicador_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_registro_estudios_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_incidencias_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_turnos_hermanos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_voluntarios_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_colaboraciones_ppam_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_disponibilidades_voluntarios_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_turnos_hermanos_maestro_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_horarios_calendario_turnos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_ubicaciones_ppam_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_ciudades_ppam_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function v_informediarioporppam_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function v_informepublicacionesporppamymes_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function v_informemensualporciudad_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function v_informemensualporpublicador_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function v_informeturnosporsemana_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_publicaciones_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_privilegios_servicio_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_responsabilidades_ppam_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_responsabilidades_congregacion_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_tipos_publicaciones_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function m_dias_semana_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
function t_turnos_validateData(){
	$j('.has-error').removeClass('has-error');
	return true;
}
