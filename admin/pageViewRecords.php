					...
					<tr>
						<td align="center">
							...
							<?php
								...
								$arrFieldCaptions = array('All tables', 'Registro de Publicaciones', 'Registro de Estudios', 'Incidencias', 'Calendario de Turnos', 'Voluntarios', 'Colaboraciones entre PPAMs', 'Disponibilidad de Voluntarios', 'Maestro de Turnos', 'Horarios Calen. Turnos', 'Zonas PPAM', 'Ciudades PPAM', 'Informe Diario', 'Informe Mensual', 'Informe Mensual por Ciudad', 'Informe por Publicador', 'Informe Turnos x Semana', 'Publicaciones', 'Privilegios de Servicio', 'Respons. PPAM', 'Resp. Congregaci&oacute;n', 'Tipos de Publicaciones', 'D&iacute;as de la Semana', 'Turnos');
