	...
	*/
	...
	if(!function_exists('getTableList')){
		function getTableList($skip_authentication = false){
			$arrTables = array(   
				't_registros_publicaciones_ppam_publicador' => 'Registro de Publicaciones',
				't_registro_estudios' => 'Registro de Estudios',
				't_incidencias' => 'Incidencias',
				't_turnos_hermanos' => 'Calendario de Turnos',
				't_voluntarios' => 'Voluntarios',
				't_colaboraciones_ppam' => 'Colaboraciones entre PPAMs',
				't_disponibilidades_voluntarios' => 'Disponibilidad de Voluntarios',
				't_turnos_hermanos_maestro' => 'Maestro de Turnos',
				't_horarios_calendario_turnos' => 'Horarios Calen. Turnos',
				't_ubicaciones_ppam' => 'Zonas PPAM',
				't_ciudades_ppam' => 'Ciudades PPAM',
				'v_informediarioporppam' => 'Informe Diario',
				'v_informepublicacionesporppamymes' => 'Informe Mensual',
				'v_informemensualporciudad' => 'Informe Mensual por Ciudad',
				'v_informemensualporpublicador' => 'Informe por Publicador',
				'v_informeturnosporsemana' => 'Informe Turnos x Semana',
				'm_publicaciones' => 'Publicaciones',
				'm_privilegios_servicio' => 'Privilegios de Servicio',
				'm_responsabilidades_ppam' => 'Respons. PPAM',
				'm_responsabilidades_congregacion' => 'Resp. Congregaci&oacute;n',
				'm_tipos_publicaciones' => 'Tipos de Publicaciones',
				'm_dias_semana' => 'D&iacute;as de la Semana',
				't_turnos' => 'Turnos'
			);
	...
	function logOutUser(){
		...
		if(isset($_COOKIE['AsisMetro_rememberMe'])){
			setcookie('AsisMetro_rememberMe', '', time()-42000);
		}
		session_destroy();
	}
	########################################################################
