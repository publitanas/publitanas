<?php
	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(   
			't_registros_publicaciones_ppam_publicador' => array('Registro de Publicaciones', '', 'resources/table_icons/attributes_display (2).png', 'None'),
			't_registro_estudios' => array('Registro de Estudios', '', 'resources/table_icons/books (2).png', 'None'),
			't_incidencias' => array('Incidencias', '', 'resources/table_icons/alarm_bell.png', 'None'),
			't_turnos_hermanos' => array('Calendario de Turnos', '', 'resources/table_icons/allow_users_edit_ranges.png', 'None'),
			't_voluntarios' => array('Voluntarios', '', 'resources/table_icons/12reseller_programm.png', 'None'),
			't_colaboraciones_ppam' => array('Colaboraciones entre PPAMs', '', 'resources/table_icons/arrow_switch.png', 'None'),
			't_disponibilidades_voluntarios' => array('Disponibilidad de Voluntarios', '', 'resources/table_icons/client_account_template.png', 'None'),
			't_turnos_hermanos_maestro' => array('Maestro de Turnos', '', 'resources/table_icons/blackboard_drawing (2).png', 'None'),
			't_horarios_calendario_turnos' => array('Horarios Calen. Turnos', '', 'resources/table_icons/clock_15.png', 'None'),
			't_ubicaciones_ppam' => array('Zonas PPAM', '', 'resources/table_icons/compass (2).png', 'None'),
			't_ciudades_ppam' => array('Ciudades PPAM', '', 'resources/table_icons/orbit.png', 'None'),
			'v_informediarioporppam' => array('Informe Diario', '', 'resources/table_icons/chart_column.png', 'None'),
			'v_informepublicacionesporppamymes' => array('Informe Mensual', '', 'resources/table_icons/chart_column.png', 'None'),
			'v_informemensualporciudad' => array('Informe Mensual por Ciudad', '', 'resources/table_icons/chart_column.png', 'None'),
			'v_informemensualporpublicador' => array('Informe por Publicador', '', 'resources/table_icons/chart_column.png', 'None'),
			'v_informeturnosporsemana' => array('Informe Turnos x Semana', '', 'resources/table_icons/chart_column_up.png', 'None'),
			'm_publicaciones' => array('Publicaciones', '', 'resources/table_icons/align_left.png', 'None'),
			'm_privilegios_servicio' => array('Privilegios de Servicio', '', 'resources/table_icons/cog (2).png', 'None'),
			'm_responsabilidades_ppam' => array('Respons. PPAM', '', 'resources/table_icons/cog (2).png', 'None'),
			'm_responsabilidades_congregacion' => array('Resp. Congregaci&oacute;n', '', 'resources/table_icons/cog (2).png', 'None'),
			'm_tipos_publicaciones' => array('Tipos de Publicaciones', '', 'resources/table_icons/cog (2).png', 'None'),
			'm_dias_semana' => array('D&iacute;as de la Semana', '', 'resources/table_icons/cog (2).png', 'None'),
			't_turnos' => array('Turnos', '', 'resources/table_icons/cog (2).png', 'None')
		);
	...
	function get_sql_fields($table_name){
		$sql_fields = array(   
			't_registros_publicaciones_ppam_publicador' => "`t_registros_publicaciones_ppam_publicador`.`IdRegistro` as 'IdRegistro', if(`t_registros_publicaciones_ppam_publicador`.`FechaRegistro`,date_format(`t_registros_publicaciones_ppam_publicador`.`FechaRegistro`,'%d-%m-%Y'),'') as 'FechaRegistro', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', IF(    CHAR_LENGTH(`t_turnos1`.`DescTurno`), CONCAT_WS('',   `t_turnos1`.`DescTurno`), '') as 'IdTurno', IF(    CHAR_LENGTH(`m_publicaciones1`.`NombrePublicacion`), CONCAT_WS('',   `m_publicaciones1`.`NombrePublicacion`), '') as 'IdPublicacion', `t_registros_publicaciones_ppam_publicador`.`CantidadColocada` as 'CantidadColocada'",
			't_registro_estudios' => "`t_registro_estudios`.`IdRegistroEstudios` as 'IdRegistroEstudios', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', `t_registro_estudios`.`NombreEstudiante` as 'NombreEstudiante', IF(    CHAR_LENGTH(`m_publicaciones1`.`NombrePublicacion`), CONCAT_WS('',   `m_publicaciones1`.`NombrePublicacion`), '') as 'IdPublicacion', `t_registro_estudios`.`Capitulo` as 'Capitulo', `t_registro_estudios`.`Parrafo` as 'Parrafo', `t_registro_estudios`.`Observaciones` as 'Observaciones'",
			't_incidencias' => "`t_incidencias`.`IdIncidencia` as 'IdIncidencia', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', if(`t_incidencias`.`FechaIncidencia`,date_format(`t_incidencias`.`FechaIncidencia`,'%d-%m-%Y'),'') as 'FechaIncidencia', if(`t_incidencias`.`FechaRegistro`,date_format(`t_incidencias`.`FechaRegistro`,'%d-%m-%Y'),'') as 'FechaRegistro', `t_incidencias`.`DescIncidencia` as 'DescIncidencia'",
			't_turnos_hermanos' => "`t_turnos_hermanos`.`IdTurnoHermano` as 'IdTurnoHermano', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', if(`t_turnos_hermanos`.`FechaAsignacionTurno`,date_format(`t_turnos_hermanos`.`FechaAsignacionTurno`,'%d-%m-%Y'),'') as 'FechaAsignacionTurno', IF(    CHAR_LENGTH(`t_turnos1`.`DescTurno`), CONCAT_WS('',   `t_turnos1`.`DescTurno`), '') as 'IdTurno', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', IF(    CHAR_LENGTH(`m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), CONCAT_WS('',   `m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), '') as 'IdResponsabilidad'",
			't_voluntarios' => "`t_voluntarios`.`IdVoluntario` as 'IdVoluntario', `t_voluntarios`.`NombreVoluntario` as 'NombreVoluntario', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', `t_voluntarios`.`TelefonoMovilVoluntario` as 'TelefonoMovilVoluntario', `t_voluntarios`.`MailVoluntario` as 'MailVoluntario', `t_voluntarios`.`CongregacionVoluntario` as 'CongregacionVoluntario', `t_voluntarios`.`Activo` as 'Activo', `t_voluntarios`.`TelefonoFijoVoluntario` as 'TelefonoFijoVoluntario', IF(    CHAR_LENGTH(`m_responsabilidades_congregacion1`.`DescResponsabilidad`), CONCAT_WS('',   `m_responsabilidades_congregacion1`.`DescResponsabilidad`), '') as 'IdResponsabilidadCongregacion', IF(    CHAR_LENGTH(`m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), CONCAT_WS('',   `m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), '') as 'IdResponsabilidadPPAM', IF(    CHAR_LENGTH(`m_privilegios_servicio1`.`DescPrivilegioServicio`), CONCAT_WS('',   `m_privilegios_servicio1`.`DescPrivilegioServicio`), '') as 'IdPrivilegiosServicio'",
			't_colaboraciones_ppam' => "`t_colaboraciones_ppam`.`IdColaboracion` as 'IdColaboracion', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM'",
			't_disponibilidades_voluntarios' => "`t_disponibilidades_voluntarios`.`IdDisponibilidad` as 'IdDisponibilidad', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', IF(    CHAR_LENGTH(`m_dias_semana1`.`DescDiaSemana`), CONCAT_WS('',   `m_dias_semana1`.`DescDiaSemana`), '') as 'IdDiaSemana', IF(    CHAR_LENGTH(`t_turnos1`.`DescTurno`), CONCAT_WS('',   `t_turnos1`.`DescTurno`), '') as 'IdTurnoDisponible', `t_disponibilidades_voluntarios`.`VecesDisponibilidadMes` as 'VecesDisponibilidadMes', `t_disponibilidades_voluntarios`.`Observaciones` as 'Observaciones'",
			't_turnos_hermanos_maestro' => "`t_turnos_hermanos_maestro`.`IdTurnoHermanoMaestro` as 'IdTurnoHermanoMaestro', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'IdPPAM', IF(    CHAR_LENGTH(`m_dias_semana1`.`DescDiaSemana`), CONCAT_WS('',   `m_dias_semana1`.`DescDiaSemana`), '') as 'IdDiaSemana', IF(    CHAR_LENGTH(`t_turnos1`.`DescTurno`), CONCAT_WS('',   `t_turnos1`.`DescTurno`), '') as 'IdTurno', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdVoluntario', IF(    CHAR_LENGTH(`m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), CONCAT_WS('',   `m_responsabilidades_ppam1`.`DescResponsabilidadPPAM`), '') as 'IdResponsabilidad'",
			't_horarios_calendario_turnos' => "`t_horarios_calendario_turnos`.`idHorarioCalendario` as 'idHorarioCalendario', IF(    CHAR_LENGTH(`t_ubicaciones_ppam1`.`NombrePPAM`), CONCAT_WS('',   `t_ubicaciones_ppam1`.`NombrePPAM`), '') as 'idPPAM', `t_horarios_calendario_turnos`.`InicioTurno1` as 'InicioTurno1', `t_horarios_calendario_turnos`.`FinTurno1` as 'FinTurno1', `t_horarios_calendario_turnos`.`InicioTurno2` as 'InicioTurno2', `t_horarios_calendario_turnos`.`FinTurno2` as 'FinTurno2', `t_horarios_calendario_turnos`.`InicioTurno3` as 'InicioTurno3', `t_horarios_calendario_turnos`.`FinTurno3` as 'FinTurno3', `t_horarios_calendario_turnos`.`InicioTurno4` as 'InicioTurno4', `t_horarios_calendario_turnos`.`FinTurno4` as 'FinTurno4'",
			't_ubicaciones_ppam' => "`t_ubicaciones_ppam`.`IdPPAM` as 'IdPPAM', `t_ubicaciones_ppam`.`NombrePPAM` as 'NombrePPAM', `t_ubicaciones_ppam`.`UbicacionPPAM` as 'UbicacionPPAM', `t_ubicaciones_ppam`.`PoblacionPPAM` as 'PoblacionPPAM', `t_ubicaciones_ppam`.`CoordenadasGPS` as 'CoordenadasGPS', IF(    CHAR_LENGTH(`t_ciudades_ppam1`.`NombreCiudad`), CONCAT_WS('',   `t_ciudades_ppam1`.`NombreCiudad`), '') as 'IdCiudadPPAM'",
			't_ciudades_ppam' => "`t_ciudades_ppam`.`IdCiudadPPAM` as 'IdCiudadPPAM', `t_ciudades_ppam`.`NombreCiudad` as 'NombreCiudad', IF(    CHAR_LENGTH(`t_voluntarios1`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios1`.`NombreVoluntario`), '') as 'IdCoordinador', IF(    CHAR_LENGTH(`t_voluntarios2`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios2`.`NombreVoluntario`), '') as 'idAuxiliarCoordinador1', IF(    CHAR_LENGTH(`t_voluntarios3`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios3`.`NombreVoluntario`), '') as 'idAuxiliarCoordinador2', IF(    CHAR_LENGTH(`t_voluntarios4`.`NombreVoluntario`), CONCAT_WS('',   `t_voluntarios4`.`NombreVoluntario`), '') as 'idAuxiliarCoordinador3'",
			'v_informediarioporppam' => "`v_informediarioporppam`.`id` as 'id', `v_informediarioporppam`.`IdPPAM` as 'IdPPAM', `v_informediarioporppam`.`ppam` as 'ppam', `v_informediarioporppam`.`fechacolocacion` as 'fechacolocacion', `v_informediarioporppam`.`publicacion` as 'publicacion', `v_informediarioporppam`.`fecha` as 'fecha', `v_informediarioporppam`.`totalesmes` as 'totalesmes'",
			'v_informepublicacionesporppamymes' => "`v_informepublicacionesporppamymes`.`id` as 'id', `v_informepublicacionesporppamymes`.`IdPPAM` as 'IdPPAM', `v_informepublicacionesporppamymes`.`ppam` as 'ppam', `v_informepublicacionesporppamymes`.`fecha` as 'fecha', `v_informepublicacionesporppamymes`.`publicacion` as 'publicacion', `v_informepublicacionesporppamymes`.`totalesmes` as 'totalesmes'",
			'v_informemensualporciudad' => "`v_informemensualporciudad`.`id` as 'id', `v_informemensualporciudad`.`IdCiudadPPAM` as 'IdCiudadPPAM', `v_informemensualporciudad`.`ciudadppam` as 'ciudadppam', `v_informemensualporciudad`.`fecha` as 'fecha', `v_informemensualporciudad`.`publicacion` as 'publicacion', `v_informemensualporciudad`.`totalesmes` as 'totalesmes'",
			'v_informemensualporpublicador' => "`v_informemensualporpublicador`.`id` as 'id', `v_informemensualporpublicador`.`IdPPAM` as 'IdPPAM', `v_informemensualporpublicador`.`ppam` as 'ppam', `v_informemensualporpublicador`.`fecha` as 'fecha', `v_informemensualporpublicador`.`voluntario` as 'voluntario', `v_informemensualporpublicador`.`publicacion` as 'publicacion', `v_informemensualporpublicador`.`totalesmes` as 'totalesmes'",
			'v_informeturnosporsemana' => "`v_informeturnosporsemana`.`id` as 'id', `v_informeturnosporsemana`.`NombreVoluntario` as 'NombreVoluntario', `v_informeturnosporsemana`.`semana` as 'semana', `v_informeturnosporsemana`.`NumeroTurnos` as 'NumeroTurnos'",
			'm_publicaciones' => "`m_publicaciones`.`IdPublicacion` as 'IdPublicacion', `m_publicaciones`.`NombrePublicacion` as 'NombrePublicacion', `m_publicaciones`.`SeUsaParaEstudiar` as 'SeUsaParaEstudiar', IF(    CHAR_LENGTH(`m_tipos_publicaciones1`.`DescTipoPublicacion`), CONCAT_WS('',   `m_tipos_publicaciones1`.`DescTipoPublicacion`), '') as 'IdTipoPublicacion'",
			'm_privilegios_servicio' => "`m_privilegios_servicio`.`IdPrivilegioServicio` as 'IdPrivilegioServicio', `m_privilegios_servicio`.`DescPrivilegioServicio` as 'DescPrivilegioServicio'",
			'm_responsabilidades_ppam' => "`m_responsabilidades_ppam`.`IdResponsabilidadPPAM` as 'IdResponsabilidadPPAM', `m_responsabilidades_ppam`.`DescResponsabilidadPPAM` as 'DescResponsabilidadPPAM'",
			'm_responsabilidades_congregacion' => "`m_responsabilidades_congregacion`.`IdResponsabilidad` as 'IdResponsabilidad', `m_responsabilidades_congregacion`.`DescResponsabilidad` as 'DescResponsabilidad'",
			'm_tipos_publicaciones' => "`m_tipos_publicaciones`.`IdTipoPublicacion` as 'IdTipoPublicacion', `m_tipos_publicaciones`.`DescTipoPublicacion` as 'DescTipoPublicacion'",
			'm_dias_semana' => "`m_dias_semana`.`IdDiaSemana` as 'IdDiaSemana', `m_dias_semana`.`DescDiaSemana` as 'DescDiaSemana'",
			't_turnos' => "`t_turnos`.`IdTurno` as 'IdTurno', `t_turnos`.`DescTurno` as 'DescTurno'"
		);
	...
	function get_sql_from($table_name, $skip_permissions = false){
		$sql_from = array(   
			...
			't_turnos_hermanos_maestro' => "`t_turnos_hermanos_maestro` LEFT JOIN `t_ubicaciones_ppam` as t_ubicaciones_ppam1 ON `t_ubicaciones_ppam1`.`IdPPAM`=`t_turnos_hermanos_maestro`.`IdPPAM` LEFT JOIN `m_dias_semana` as m_dias_semana1 ON `m_dias_semana1`.`IdDiaSemana`=`t_turnos_hermanos_maestro`.`IdDiaSemana` LEFT JOIN `t_turnos` as t_turnos1 ON `t_turnos1`.`IdTurno`=`t_turnos_hermanos_maestro`.`IdTurno` LEFT JOIN `t_disponibilidades_voluntarios` as t_disponibilidades_voluntarios1 ON `t_disponibilidades_voluntarios1`.`IdDisponibilidad`=`t_turnos_hermanos_maestro`.`IdVoluntario` LEFT JOIN `t_voluntarios` as t_voluntarios1 ON `t_voluntarios1`.`IdVoluntario`=`t_disponibilidades_voluntarios1`.`IdVoluntario` LEFT JOIN `m_responsabilidades_ppam` as m_responsabilidades_ppam1 ON `m_responsabilidades_ppam1`.`IdResponsabilidadPPAM`=`t_turnos_hermanos_maestro`.`IdResponsabilidad` ",
			't_horarios_calendario_turnos' => "`t_horarios_calendario_turnos` LEFT JOIN `t_ubicaciones_ppam` as t_ubicaciones_ppam1 ON `t_ubicaciones_ppam1`.`IdPPAM`=`t_horarios_calendario_turnos`.`idPPAM` ",
			't_ubicaciones_ppam' => "`t_ubicaciones_ppam` LEFT JOIN `t_ciudades_ppam` as t_ciudades_ppam1 ON `t_ciudades_ppam1`.`IdCiudadPPAM`=`t_ubicaciones_ppam`.`IdCiudadPPAM` ",
			't_ciudades_ppam' => "`t_ciudades_ppam` LEFT JOIN `t_voluntarios` as t_voluntarios1 ON `t_voluntarios1`.`IdVoluntario`=`t_ciudades_ppam`.`IdCoordinador` LEFT JOIN `t_voluntarios` as t_voluntarios2 ON `t_voluntarios2`.`IdVoluntario`=`t_ciudades_ppam`.`idAuxiliarCoordinador1` LEFT JOIN `t_voluntarios` as t_voluntarios3 ON `t_voluntarios3`.`IdVoluntario`=`t_ciudades_ppam`.`idAuxiliarCoordinador2` LEFT JOIN `t_voluntarios` as t_voluntarios4 ON `t_voluntarios4`.`IdVoluntario`=`t_ciudades_ppam`.`idAuxiliarCoordinador3` ",
			'v_informediarioporppam' => "`v_informediarioporppam` ",
			'v_informepublicacionesporppamymes' => "`v_informepublicacionesporppamymes` ",
			'v_informemensualporciudad' => "`v_informemensualporciudad` ",
			'v_informemensualporpublicador' => "`v_informemensualporpublicador` ",
			'v_informeturnosporsemana' => "`v_informeturnosporsemana` ",
			'm_publicaciones' => "`m_publicaciones` LEFT JOIN `m_tipos_publicaciones` as m_tipos_publicaciones1 ON `m_tipos_publicaciones1`.`IdTipoPublicacion`=`m_publicaciones`.`IdTipoPublicacion` ",
			'm_privilegios_servicio' => "`m_privilegios_servicio` ",
			'm_responsabilidades_ppam' => "`m_responsabilidades_ppam` ",
			'm_responsabilidades_congregacion' => "`m_responsabilidades_congregacion` ",
			'm_tipos_publicaciones' => "`m_tipos_publicaciones` ",
			'm_dias_semana' => "`m_dias_semana` ",
			't_turnos' => "`t_turnos` "
		);

		$pkey = array(   
			't_registros_publicaciones_ppam_publicador' => 'IdRegistro',
			't_registro_estudios' => 'IdRegistroEstudios',
			't_incidencias' => 'IdIncidencia',
			't_turnos_hermanos' => 'IdTurnoHermano',
			't_voluntarios' => 'IdVoluntario',
			't_colaboraciones_ppam' => 'IdColaboracion',
			't_disponibilidades_voluntarios' => 'IdDisponibilidad',
			't_turnos_hermanos_maestro' => 'IdTurnoHermanoMaestro',
			't_horarios_calendario_turnos' => 'idHorarioCalendario',
			't_ubicaciones_ppam' => 'IdPPAM',
			't_ciudades_ppam' => 'IdCiudadPPAM',
			'v_informediarioporppam' => 'id',
			'v_informepublicacionesporppamymes' => 'id',
			'v_informemensualporciudad' => 'id',
			'v_informemensualporpublicador' => 'id',
			'v_informeturnosporsemana' => 'id',
			'm_publicaciones' => 'IdPublicacion',
			'm_privilegios_servicio' => 'IdPrivilegioServicio',
			'm_responsabilidades_ppam' => 'IdResponsabilidadPPAM',
			'm_responsabilidades_congregacion' => 'IdResponsabilidad',
			'm_tipos_publicaciones' => 'IdTipoPublicacion',
			'm_dias_semana' => 'IdDiaSemana',
			't_turnos' => 'IdTurno'
		);
	...
	function logInMember(){
		...
		if($_POST['signIn'] != ''){
			if($_POST['username'] != '' && $_POST['password'] != ''){
				...
				if(sqlValue("select count(1) from membership_users where lcase(memberID)='$username' and passMD5='$password' and isApproved=1 and isBanned=0")==1){
					...
					if($_POST['rememberMe']==1){
						@setcookie('AsisMetro_rememberMe', md5($username.$password), time()+86400*30);
					}else{
						@setcookie('AsisMetro_rememberMe', '', time()-86400*30);
					}
			...
			exit;
		}elseif((!$_SESSION['memberID'] || $_SESSION['memberID']==$adminConfig['anonymousMember']) && $_COOKIE['AsisMetro_rememberMe']!=''){
			$chk=makeSafe($_COOKIE['AsisMetro_rememberMe']);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> AsisMetro</a>
			</div>
	...
	function NavMenus($options = array()){
		...
		if(is_array($arrTables)){
			foreach($arrTables as $tn => $tc){
				...
				$tChkHL = array_search($tn, array('t_registros_publicaciones_ppam_publicador','t_registro_estudios','t_incidencias','t_turnos_hermanos','t_voluntarios','t_colaboraciones_ppam','t_disponibilidades_voluntarios','t_turnos_hermanos_maestro','t_horarios_calendario_turnos','t_ubicaciones_ppam','t_ciudades_ppam','v_informediarioporppam','v_informepublicacionesporppamymes','v_informemensualporciudad','v_informemensualporpublicador','v_informeturnosporsemana','m_publicaciones','m_privilegios_servicio','m_responsabilidades_ppam','m_responsabilidades_congregacion','m_tipos_publicaciones','m_dias_semana','t_turnos'));
